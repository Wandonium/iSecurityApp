...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, CameraWrapper cameraWrapper, Camera.PictureCallback pictureCallback) {
        super(context);
        init(cameraWrapper, pictureCallback);
    }

    public CameraPreview(Context context, AttributeSet attrs, CameraWrapper cameraWrapper, Camera.PictureCallback pictureCallback) {
        super(context, attrs);
        init(cameraWrapper, pictureCallback);
    }

    public void init(CameraWrapper cameraWrapper, Camera.PictureCallback pictureCallback) {
        setCamera(cameraWrapper, pictureCallback);
        mAutoFocusHandler = new Handler();
        getHolder().addCallback(this);
        getHolder().setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
    }

    public void setCamera(CameraWrapper cameraWrapper, Camera.PictureCallback pictureCallback) {
    ...
    public void showCameraPreview() {
        if(mCameraWrapper != null) {
            try {
                ...
                //mCameraWrapper.mCamera.setOneShotPreviewCallback(mPictureCallback);
    ...
    public void setupCameraParameters() {
        ...
        List<Camera.Size> pictureSizes = mCameraWrapper.mCamera.getParameters().getSupportedPictureSizes();
        for(Camera.Size size : pictureSizes) {
            System.out.println("Allowed picture size: " + size.width + " " + size.height);
        }
