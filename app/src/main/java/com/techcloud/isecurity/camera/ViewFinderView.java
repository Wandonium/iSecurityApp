...
public class ViewFinderView extends View implements IViewFinder {
    ...
    public synchronized void updateFramingRect() {
        ...
        System.out.println("rect.left: " + mFramingRect.left);
        System.out.println("mFramingRect.right: " + mFramingRect.right);
        System.out.println("mFramingRect.top: " + mFramingRect.top);
        System.out.println("mFramingRect.bottom: " + mFramingRect.bottom);
    }
}
