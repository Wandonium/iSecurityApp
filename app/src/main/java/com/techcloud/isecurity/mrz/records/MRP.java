...
public class MRP extends MrzRecord {
    ...
    public void fromMrz(String mrz) {
        ...
        serialNumber = parser.parseString(new MrzRange(0, 9, 1));
    ...
    public String toMrz() {
        ...
        sb.append('\n');
        // second line
        final String docNum = MrzParser.toMrz(serialNumber, 9) + MrzParser.computeCheckDigitChar(MrzParser.toMrz(serialNumber, 9));
        sb.append(docNum);
