...
public class MrzParser {
    ...
    private static Logger log = Logger.getLogger(MrzParser.class.getSimpleName());
    ...
    public MrzDate parseDate(MrzRange range) {
        ...
        try {
            ...
            year = -1;
//            log.info("Failed to parse MRZ date year " + rawValue(range) + ": " + ex, mrz, r);
        }
        if (year < 0 || year > 99) {
            log.info("Invalid year value " + year + ": must be 0..99");
        }
        ...
        try {
            ...
            month = -1;
//            log.info("Failed to parse MRZ date month " + rawValue(range) + ": " + ex, mrz, r);
        }
        if (month < 1 || month > 12) {
            log.info("Invalid month value " + month + ": must be 1..12");
        }
...
//            log.info("Failed to parse MRZ date month " + rawValue(range) + ": " + ex, mrz, r);
        ...
        if (day < 1 || day > 31) {
            log.info("Invalid day value " + day + ": must be 1..31");
        }
