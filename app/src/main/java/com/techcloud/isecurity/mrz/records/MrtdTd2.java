...
public class MrtdTd2 extends MrzRecord {
    ...
    public void fromMrz(String mrz) {
        ...
        serialNumber = p.parseString(new MrzRange(0, 9, 1));
    ...
    public String toMrz() {
        ...
        sb.append('\n');
        // second line
        final String dn = MrzParser.toMrz(serialNumber, 9) + MrzParser.computeCheckDigitChar(MrzParser.toMrz(serialNumber, 9));
        sb.append(dn);
