package com.techcloud.isecurity.mrz.records;
...
public class MrtdTd1 extends MrzRecord {
    ...
    public void fromMrz(String mrz) {
        ...
        serialNumber = p.parseString(new MrzRange(5, 14, 0));
    ...
    public String toString() {
        return "Document Number = " + optional2.substring(0, optional2.length()-1) + "\n" + super.toString();
    }
    ...
    public String toMrz() {
        ...
        final String dno = MrzParser.toMrz(serialNumber, 9) + MrzParser.computeCheckDigitChar(MrzParser.toMrz(serialNumber, 9)) + MrzParser.toMrz(optional, 15);
        sb.append(dno);
        sb.append('\n');
        // second line
    ...
    public String getDocumentNumber() {
        return optional2.substring(0, optional2.length()-1);
    }
}
